...
if (process.env.PRIVATE_KEYS) {
    var keys = process.env.PRIVATE_KEYS.split(' ')
}
...
var devPKey = keys || ['a0cf475a29e527dcb1c35f66f1d78852b14d5f5109f75fa4b38fbe46db2022a5']
var devEndPoint = 'http://rpc.testnet.ezdefi.com'
...
module.exports = {
    networks: {
        ...
        development: {
            provider: () => new HDWalletProvider(devPKey, devEndPoint, 0, devPKey.length),
            network_id: 111111
        },
        production: {
